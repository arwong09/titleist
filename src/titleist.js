define(["react"], function(React) {
    ...
    render: function() {
      return (
        React.createElement("div", null, 
          React.createElement("input", {type: "text", name: "title", id: "titleist-input", onChange: this.handleChange, ref: "input", value: this.state.value}), 
          React.createElement("label", {className: "titleist-toggle-label"}, 
            React.createElement("i", {className: "fa fa-bolt toggled-" + this.state.checked}), 
            React.createElement("input", {type: "checkbox", id: "titleist-toggle", ref: "checkbox", onChange: this.toggleChecked, checked: this.state.checked})
          )
        )
      )
    }
  ...
  var Titleist = {
    initialize: function(selector, customOptions) {
      ...
      React.render(React.createElement(TitleistComponent, null), document.getElementById(selector));
    }
  }
